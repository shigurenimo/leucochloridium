...
const help = `leuco projects <p> connectors <c> download-file / download a private Slack file

usage / leuco projects <p> connectors <c> download-file (--file <id>|--url <url>) --out <path>
...
export const connectorsDownloadFileHandler = factory.createHandlers(async (c) => {
