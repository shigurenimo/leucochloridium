/**
 * Organisation and maintenance rules for the project CODEX_HOME/AGENTS.md.
...
The project AGENTS.md identified above is both durable instructions and long-term memory. Keep important memory there; do not delete it merely to shorten the prompt.
...
- When asked to update your own rules or memory, use the project file. A repository AGENTS.md has a separate scope and changes only when the user means repository instructions.
`,
} as const
